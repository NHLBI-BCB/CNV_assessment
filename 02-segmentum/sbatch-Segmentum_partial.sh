...
## with BAF
# Segmentum analyze without BAF <tumor> <normal> <BAF_file> <window_size> <clogr_threshold> <BAF_threshold> [-m N] [-l N] [-b N] [-p N] [-B N]     

Segmentum analyze without BAF  $sid.t.wig.gz    $sid.n.wig.gz   11   0.7  -p False
